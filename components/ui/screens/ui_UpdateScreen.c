...
void ui_UpdateScreen_screen_init(void)
{
    ...
    lv_label_set_text(ui_OTASuccess, "更新成功,重启中");
    ...
    lv_label_set_text(ui_OTASuccess1, "更新成功,重启中");
    ...
    lv_label_set_text(ui_OTAFail, "更新失败,重启中");
    lv_obj_add_flag(ui_OTAFail, LV_OBJ_FLAG_HIDDEN);     /// Flags
    ...
    lv_label_set_text(ui_OTAFail1, "更新失败,重启中");
